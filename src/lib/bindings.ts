 ...
 */
async logFrontendError(message: string, stack: string | null) : Promise<void> {
    await TAURI_INVOKE("log_frontend_error", { message, stack });
},
/**
...
async getDefaultLeftSidebarShortcut() : Promise<string> {
    return await TAURI_INVOKE("get_default_left_sidebar_shortcut");
},
async getDefaultRightSidebarShortcut() : Promise<string> {
    return await TAURI_INVOKE("get_default_right_sidebar_shortcut");
},
async updateLeftSidebarShortcut(shortcut: string | null) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_left_sidebar_shortcut", { shortcut }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updateRightSidebarShortcut(shortcut: string | null) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_right_sidebar_shortcut", { shortcut }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * If None, uses the default shortcut
 */
left_sidebar_shortcut: string | null; 
/**
 * Global shortcut for right sidebar toggle
 * If None, uses the default shortcut
 */
right_sidebar_shortcut: string | null; 
/**
